...
entry:
  ...
  %b1 = alloca i1
  %b2 = alloca i1
  store i32 3000, i32* %x
  store i32 -3000, i32* %y
  %x1 = load i32* %x
  %tmp = icmp slt i32 %x1, 1000000
  store i1 %tmp, i1* %b1
  %y2 = load i32* %y
  %tmp3 = icmp sgt i32 %y2, -1000000
  store i1 %tmp3, i1* %b2
  %b14 = load i1* %b1
  %printf = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt, i32 0, i32 0), i1 %b14)
  %b25 = load i1* %b2
  %printf6 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt, i32 0, i32 0), i1 %b25)
  ret i32 0
}
