...
entry:
  ...
  store i32 %d, i32* %d4
  %a5 = load i32* %a1
  %printf = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt5, i32 0, i32 0), i32 %a5)
  %b6 = load i32* %b2
  %printf7 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt5, i32 0, i32 0), i32 %b6)
  %c8 = load i32* %c3
  %printf9 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt5, i32 0, i32 0), i32 %c8)
  %d10 = load i32* %d4
  %printf11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @fmt5, i32 0, i32 0), i32 %d10)
  ret void
}
