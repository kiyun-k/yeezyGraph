...
let struct_types = 
  ...
  (* LLVM type for a given AST type *)
  let ltype_of_typ = function 
      A.Int -> i32_t
    | A.Bool -> i1_t
    | A.String -> L.pointer_type i8_t
    | A.Void -> void_t 
    | A.StructType s -> StringMap.find s struct_types in
